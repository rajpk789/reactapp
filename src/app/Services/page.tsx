        ...
        <div className='text-white'>
            ...
            <div className="bg-black md:px-20 ">
                        ...
                        <ul className="me-12 ">
                            ...
                            <div className='mt-10 border p-5' >
                                ...
                                <p className=''>Attiguppe,Vijay
                                    Nagar,<br />Banglore-560 040</p>
                                <h3 className='font-bold text-xl py-2'>Quick Contact Us</h3>
                                <p className='' >info@rnrbuildtech.com</p>
                                <p className=''>Call Us:+91 9880580763</p>
                                <h3 className='font-bold text-xl py-2'>Office Opening Hours</h3>
                ...
                <div className="py-12 p-8">
                    ...
                    <p className="py-2">We create fully customized residential units to meet the needs of our clients. We work with complete transparency, carefully adhering to every single legal requirement, and utilizing only marked, institutionalized materials for development. Because we are the best civil engineering contractors in Bangalore, we guarantee to build wonderful homes that are based on your needs and reflect your personality. We take care of complete construction management that’s why we are the best Building Contractors in Bangalore. We are professional for renovation and interior design services also we have more creative experience and capabilities for excellent renovation and interior design services.</p>
                </div>
            </div>
        </div>
    )
