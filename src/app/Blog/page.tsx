    ...
    <div className='text-white'>
            ...
            <div className="bg-black px-20">
                ...
                <div className="mx-16 text-black bg-white p-10">
                    ...
                    <p className="py-2">To begin with, there are only some builders whose company is registered. Have you wondered why?</p>
                    <p className="py-2">This means that there is an element of separation between them as businesses and them as individuals. It works to protect and legitimize the builder and any dealings you do with them.</p>
                    <p className="py-2">Good news: It also makes it easier to check on their past work. You should ask for confirmation that no claims have been made against the company in the last five years, so you know that they’ve got a good track record and can be trusted. Make no mistake about it.</p>
                    <h1 className="font-bold py-3">2. Does the builder have an in-house team of engineers in their team?</h1>
                    <p className="py-2">To begin with, there are only some builders whose company is registered. Have you wondered why?</p>
